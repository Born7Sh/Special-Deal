		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main">
					...
					<section>
						<header class="major">
						<h2><%=(String)session.getAttribute("id") %>님의 특가 정보 작성 글</h2>
						</header>	
						<div class="row">
					<%
						ResultSet rs=null;
						...
						Integer post_num;
						try{
							String sql = "select * from Sale_Table where post_member_id = ? order by post_num desc limit ?,?";
				...
				<li class="prevEnd">
					<a href="sale_history.jsp?page_num=<%=page_num-1%>"><i class="ti-angle-left"></i> PREV</a>
				</li>
				<li>
					<strong class="page_on"><%=page_num %></strong>
				</li>
				<li class="nextEnd">
					<a href="sale_history.jsp?page_num=<%=page_num+1%>">NEXT <i class="ti-angle-right"></i></a>
				</li>
					</ul>
					</div>
				</section>
