	...
	<nav class = "navbor navbor-default">
		<div class = "container" id ="xet-boardWrp">
						...
						<tbody>
							<tr class="bg2">			
								...
								try{
									...
									String sql = "select * from User_Table where post_title like '\"%" +search+"%\"'" + "order by post_num desc limit ?,?";
			...
			<ul class="boardPagination">
				<li class="prevEnd">
					<a href="user_board_search.jsp?page_num=<%=page_num-1%>&search=<%=search%>"><i class="ti-angle-left"></i> PREV</a>
				</li>
				<li>
					<strong class="page_on"><%=page_num %></strong>
				</li>
				<li class="nextEnd">
					<a href="user_board_search.jsp?page_num=<%=page_num+1%>&search=<%=search%>">NEXT <i class="ti-angle-right"></i></a>
				</li>
					</ul>
