	...
	<nav class = "navbor navbor-default">
		<div class = "container" id ="xet-boardWrp">
						...
						<tbody>
							<tr class="bg2">			
								...
								try{
									...
									String sql = "select post_num, post_title, post_date,member_id from User_Table where member_id = ? order by post_num desc limit ?,? ";
			...
			<ul class="boardPagination">
				<li class="prevEnd">
					<a href="user_board_history.jsp?page_num=<%=page_num-1%>"><i class="ti-angle-left"></i> PREV</a>
				</li>
				<li>
					<strong class="page_on">1</strong>
				</li>
				<li class="nextEnd">
					<a href="user_board_history.jsp?page_num=<%=page_num+1%>">NEXT <i class="ti-angle-right"></i></a>
				</li>
			</ul>
