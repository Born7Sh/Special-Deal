...
<jsp:setProperty name = "rbi" property = "post_num"/>
<!DOCTYPE HTML>
<!--
	...
	<nav class = "navbor navbor-default">
		<div class ="container">
			<div class="row">
				...
				<form method="post" action="request_table_rewrite_process.jsp">
					<table class="board_view" style="text-align: center; border: 1px solid #dddddd">
						<colgroup>
        			<col width="15%" >
        			<col width="*" >
     				</colgroup>
 					 	<h3 style="text-align: center;">신고/문의게시글 작성</h3>
	      			<tbody>
          			<tr>
          				&nbsp;
              			<th scope="row">제목</th>
          			...
          			<tr>
	          			...
	          			<td><textarea cols="100" rows="20" id="post_content" name="post_content" title="내용"></textarea></td>
							...
							<button style="float:right;"type = "button" onclick="location.href='list-inquiryboard.jsp?page_num=1'" class="btn btn-primary pull-right">목록으로</button>
			</form>
      			</div>
