...
<body class="homepage is-preload">
	...
	<nav class = "navbor navbor-default">
		<div class ="container">
			...
			<input type ="button" class ="btn btn-primary pull-right" value="글 목록">
			<!--<a href="list.jsp" "btn btn-primary pull-right" value="글 목록">  -->
			
			<input type ="button" class ="btn btn-primary pull-right" value="글 수정">
			
			
			<input type ="button" class ="btn btn-primary pull-right" value="글 삭제">
