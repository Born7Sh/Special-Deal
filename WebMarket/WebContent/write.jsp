...
<body class="homepage is-preload">
	...
	<nav class = "navbor navbor-default">
		<div class ="container">
			<div class="row">
				<div class="col-12">
				<form method="post" action="sale_table_write_process.jsp" enctype="multipart/form-data">
        			...
        			<col width="*" >
          			...
          			<tr>
              			<th scope="row">제목</th>
              			<td><input type="text"  name="post_title" class="wdp_90" /></td>
          			</tr>
          			<tr>
          				<th scope ="row">기간 설정</th>
          				<td>
  							<input type='text' class="datepicker-min" name="sale_start" style="width:49%;float:left;"/>
  							<input type='text' class="datepicker-max" name="sale_end" style="width:49%;float:right;"/>
						</td>
          			</tr>
          			<tr>
          				<th scope ="row">링크</th>
          				<td><input type = "text" name="post_link" class = "wdp_90"/></td>
          			</tr>
          			<tr>
	          			<th scope="row">내용</th>
