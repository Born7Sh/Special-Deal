						...
						<tbody>
							...
							<% 
								...
								try{
									...
									int post_recommend;
									String sql = "select post_num, post_title, post_date, post_read,post_member_id,post_recommend from Sale_Table order by post_num desc limit 0,10 ";
									...
									while(rs.next()){
										...
										post_recommend = rs.getInt("post_recommend");
								...
								<td><%=Integer.toString(post_recommend)%></td>
								</tr>
								<%
