			...
			<%
			    ...
			    int isSuccess = 0;
				 try{
						...
						isSuccess = biDAO.boardWrite(1,bi.getCategory_num(),bi.getPost_title(),bi.getPost_content(), "http://kpuweb.iptime.org:8080/image/"+file,
								bi.getSale_start(),bi.getSale_end(),bi.getPost_member_id(),bi.getPost_link());
