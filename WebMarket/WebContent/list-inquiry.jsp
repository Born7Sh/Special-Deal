		...
		<div class = "container" id ="xet-boardWrp">
			<div class="xet-listWrp">
				<div class="xet-listTableWrp">
						...
						<tbody>
							<tr class="bg2">			
								...
								try{
									...
									String post_date;
									String member_id;
									String post_isSolved;
									String sql = "select post_num, post_title, post_date,member_id,post_isSolved from Request_Table order by post_num desc limit ?,? ";
								...
								<td class="td-subject">
									<a href="request_board_view.jsp?post_num=<%=post_num %>" ><%=post_title%></a>
								</td>																																																								
								<td>
					...
					<%
						if(is_Logined==1){
							out.println("<button type='submit' onclick='location.href=\"request_write.jsp\"' class='btn btn-primary pull-right'>글쓰기</button>");
						}
						else{}
					%>
			...
			<ul class="boardPagination">
				<li class="prevEnd">
					<a href="list-inquiry.jsp?page_num=<%=page_num-1%>"><i class="ti-angle-left"></i> PREV</a>
				</li>
				<li>
					<strong class="page_on"><%=page_num %></strong>
				</li>
				<li class="nextEnd">
					<a href="list-inquiry.jsp?page_num=<%=page_num+1%>">NEXT <i class="ti-angle-right"></i></a>
				</li>
			</ul>
			<div class="boardSearch">
				<form action="request_board_search.jsp?page_num=1" method="get" onsubmit="return procFilter(this, search)" id="fo_search" class="boardSearchForm"><input type="hidden" name="act" value="">
					<div class="">
