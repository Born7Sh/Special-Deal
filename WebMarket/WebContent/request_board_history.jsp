	...
	<nav class = "navbor navbor-default">
		<div class = "container" id ="xet-boardWrp">
						...
						<tbody>
							<tr class="bg2">			
								...
								try{
									...
									String sql = "select * from Request_Table where member_id = ? order by post_num desc limit ?,?";
			...
			<ul class="boardPagination">
				<li class="prevEnd">
					<a href="request_board_history.jsp?page_num=<%=page_num-1%>"><i class="ti-angle-left"></i> PREV</a>
				</li>
				<li>
					<strong class="page_on">1</strong>
				</li>
				<li class="nextEnd">
					<a href="request_board_history.jsp?page_num=<%=page_num+1%>">NEXT <i class="ti-angle-right"></i></a>
				</li>
			</ul>
